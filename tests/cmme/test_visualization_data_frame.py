...
from cmme.drex.util import drex_default_results_file_path, drex_default_instructions_file_path
...
def test_init_succeeds():
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        drex_instance\
            ...
            .save_self(drex_default_instructions_file_path(None, tmpdir_path))
