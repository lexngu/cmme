...
if isfield(instructions_file, "estimate_suffstat")
    ...
    es_results = estimate_suffstat(es_instructions.xs, es_instructions.params);

    % and: plug-in calculated prior into params for run_DREX_model.m
    rdm_instructions.params.prior = es_results;
else % use provided prior parameterization
